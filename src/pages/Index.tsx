...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section id="calculator" className="py-20 bg-gradient-to-b from-accent to-white">
        <div className="container mx-auto px-4">
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <h2 className="text-3xl font-bold text-primary mb-4">
              Get Started with GDP Calculator
            </h2>
            <p className="text-secondary text-lg max-w-2xl mx-auto">
              Use our advanced ML model to predict GDP trends based on key economic indicators.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <ul className="space-y-3 text-secondary">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Real-time GDP forecasting</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Brain className="h-5 w-5 text-primary mt-1 shrink-0" />
                    <span>ML-powered economic analysis</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Shield className="h-5 w-5 text-primary mt-1 shrink-0" />
                    <span>Accurate prediction models</span>
                  </li>
                </ul>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="space-y-4 text-secondary">
                <p>1. Enter key economic indicators</p>
                <p>2. Our ML model processes the data</p>
                <p>3. Get GDP predictions and trends</p>
                <p>4. View detailed analysis and insights</p>
              </div>
              <Button 
                size="lg" 
